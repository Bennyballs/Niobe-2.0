...
final class ProjectileModel extends Animable
{
	...
	public Model getRotatedModel()
	{
		...
		model_1.setLighting(64 + aSpotAnim_1592.anInt413, 850 + aSpotAnim_1592.anInt414, -30, -50, -30, true, false);
		return model_1;
	}

	public ProjectileModel(int i, int j, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2)
	{
		aBoolean1579 = false;
