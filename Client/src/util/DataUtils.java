...
public class DataUtils {
	...
	/**
	 * Writes a string in the form of bytes that can be read by Jagex data methods.
	...
	/**
	 * Writes 3 bytes(24 bits) to the output stream that can be read by Jagex data methods.
	 * @param dat output stream.
	 * @param i input value.
	 * @throws IOException
	 */
