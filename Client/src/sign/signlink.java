...
public final class signlink implements Runnable {
	...
	public static String cacheLocationOrig() {
		String locations[] = {
				"c:/windows/", "c:/WINDOWS/", "c:/winnt/", "d:/windows/", "d:/winnt/", "e:/windows/", "e:/winnt/", "f:/windows/", "f:/winnt/", "c:/", "~/",
				"/tmp/", "", "c:/rscache", "/rscache"
		};
		String cacheFolder = ".anarchypk";
		for (int i = 0; i < locations.length; i++) {
			try {
				...
				if (finalDirectory.exists() || finalDirectory.mkdir())
					return location + cacheFolder + System.getProperty("file.separator");
			} catch (Exception _ex) {
			}
		}
		return System.getProperty("user.home") + System.getProperty("file.separator") + cacheFolder + System.getProperty("file.separator");
	}

    public static String getCacheLocation() {
    	String name = ".anarchypk";
	...
	public static String secondaryLocation() {
		File file = new File("c:/.anarchypk/");
		if (!file.exists())
			file.mkdir();
