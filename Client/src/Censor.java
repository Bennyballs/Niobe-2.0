...
final class Censor {
	...
	public static void loadConfig(JagexArchive streamLoader) {
		JagexBuffer stream = new JagexBuffer(
				streamLoader.getData("fragmentsenc.txt"));
		JagexBuffer stream_1 = new JagexBuffer(
				streamLoader.getData("badenc.txt"));
		JagexBuffer stream_2 = new JagexBuffer(
				streamLoader.getData("domainenc.txt"));
		JagexBuffer stream_3 = new JagexBuffer(
				streamLoader.getData("tldlist.txt"));
		readValues(stream, stream_1, stream_2, stream_3);
	}

	private static void readValues(JagexBuffer stream, JagexBuffer stream_1,
			JagexBuffer stream_2, JagexBuffer stream_3) {
		readBadEnc(stream_1);
	...
	private static void readTldList(JagexBuffer stream) {
	...
	private static void readBadEnc(JagexBuffer stream) {
