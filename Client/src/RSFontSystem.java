...
public class RSFontSystem extends DrawingArea {
    ...
    public RSFontSystem(boolean TypeFont, String s, JagexArchive archive) {
    	try {
	        ...
	        JagexBuffer stream = new JagexBuffer(archive.getData(s + ".dat"));
	        JagexBuffer stream_1 = new JagexBuffer(archive.getData("index.dat"));
