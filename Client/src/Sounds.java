...
final class Sounds {
	...
	public static void unpack(JagexBuffer stream) {
		...
		aStream_328 = new JagexBuffer(aByteArray327);
		Class6.method166();
		do {
			...
			sound[j] = aSoundsArray325s[j].method243();
		} while (true);
	}

	public static JagexBuffer method241(int i, int j) {
	...
	public static final int[] sound = new int[5000];
	private static byte[] aByteArray327;
	private static JagexBuffer aStream_328;
