 ...
 * representing a default weapon, used when the player is not wielding
 * an item.
 *
 * @author relex lawl
 */
public final class DefaultWeapon extends Weapon {

	/**
	 * The DefaultWeapon constructor.
	 ...
	 */
	private static final Animation BLOCK_ANIMATION = new Animation(424);
