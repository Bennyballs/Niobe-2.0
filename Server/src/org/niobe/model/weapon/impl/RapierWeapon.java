 ...
 * representing a rapier.
 *
 * @author relex lawl
 */
public final class RapierWeapon extends Weapon {

	/**
	 * The RapierWeapon constructor.
	 * @param id	The weapon id.
	 */
	public RapierWeapon(int id) {
		super(id);
	}
	 ...
	 */
	private final static Animation BLOCK_ANIMATION = new Animation(13038);
